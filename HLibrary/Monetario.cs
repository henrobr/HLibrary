...
namespace HLibrary
{
    ...
    {
        //Calculo de Juros diarios de acordo com a taxa mensal
        public static decimal CalculaJurosDiario(decimal valor, decimal taxa)
        {
            decimal resultado = Math.Round(((valor * taxa) / 100) / 30, 2);
            return resultado;
        }
        //Calculo de mutta
        public static decimal CalculaMulta(decimal valor, decimal taxa)
        {
            decimal resultado = Math.Round((valor * taxa) / 100, 2);
            return resultado;
        }
